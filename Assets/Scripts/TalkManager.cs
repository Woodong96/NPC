...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        talkData.Add(1001, new string[] { "안녕?", "난 NPC1이야" });
        talkData.Add(1002, new string[] { "안녕", "잘부탁해" });
        talkData.Add(1003, new string[] { "난 NPC3란다" });
        talkData.Add(1004, new string[] { "하이", "난 npc4야" });

        //Quest Talk
        talkData.Add(10 + 1001, new string[] { "안녕?:0", "반가워:1", "NPC2을도와주자:0"});
        talkData.Add(11 + 1002, new string[] { "내부탁좀들어줘:0","내가발을찾아줘:2" });
        talkData.Add(20 + 5000, new string[] { "가발을 찾았다:1", "갓다주자!:1" });
        talkData.Add(20 + 1002, new string[] { "엇, 찾아줘서 고마워:2" });
